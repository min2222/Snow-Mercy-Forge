        ...
        if (snowGolemEntity.getHead() == 2) {
            ...
            if (!snowGolemEntity.isInvisible() || bl) {
                ...
                if (bl) {
                    ...
                    minecraftClient.getItemRenderer().renderStatic(snowGolemEntity, itemStack, ItemDisplayContext.HEAD, false, matrixStack, vertexConsumerProvider, snowGolemEntity.level, i, LivingEntityRenderer.getOverlayCoords(snowGolemEntity, 0.0F), snowGolemEntity.getId());
                }
