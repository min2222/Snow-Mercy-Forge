...
public class SnowMercyBlocks {
	...
	public static final RegistryObject<FrozenLodestoneBlock> FROZEN_LODESTONE = BLOCKS.register("frozen_lodestone", () -> new FrozenLodestoneBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.5F).sound(SoundType.GLASS)));
}
