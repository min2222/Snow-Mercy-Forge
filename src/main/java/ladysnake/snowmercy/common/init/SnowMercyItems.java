...
public class SnowMercyItems {
    ...
    public static RegistryObject<SkillotineItem> SKILLOTINE = ITEMS.register("skillotine", () -> new SkillotineItem(Tiers.DIAMOND, 3, -2.4f, new Item.Properties()));
    public static RegistryObject<CoalBurnerItem> COAL_BURNER = ITEMS.register("coal_burner", () -> new CoalBurnerItem(new Item.Properties().stacksTo(1).durability(13000)));
    public static RegistryObject<SledgeItem> SLEDGE = ITEMS.register("hammersledge", () -> new SledgeItem(new Item.Properties().stacksTo(1)));
