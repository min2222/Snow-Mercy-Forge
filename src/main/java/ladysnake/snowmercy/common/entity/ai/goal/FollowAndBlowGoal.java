...
public class FollowAndBlowGoal extends Goal {
    ...
    public FollowAndBlowGoal(PathfinderMob mob, double speed, boolean pauseWhenMobIdle) {
        this.mob = mob;
        this.speed = speed;
    ...
    protected double getSquaredMaxAttackDistance(LivingEntity entity) {
        return this.mob.getBbWidth() * 3.0F * this.mob.getBbWidth() * 3.0F + entity.getBbWidth();
    }
}
